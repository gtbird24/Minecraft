...
public class Block
{
    ...
    //Erik Added Block
    public static final Block BlockExample  = (new BlockExample(159)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("exampleblock");
    ...
    {
        if(Variables.jadeVision && this.blockID != Block.oreDiamond.blockID )
        {
        	return 1000f;
        }
        else if(Variables.jadeVision && this.blockID == Block.oreDiamond.blockID)
        {
        	return 5000f;
        }
