...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        {
        	//Display Button Key Press Enabled Hacks
        	if(Variables.hackJump)
         	{
         		var8.drawStringWithShadow("J: High Jump", 2, 2, 0x00ff00);
         	}
        	
        	if(Variables.jadeVision)
        	{
        		var8.drawStringWithShadow("V: Jade Vision", 2, 12, 0x00ff00);
        	}
