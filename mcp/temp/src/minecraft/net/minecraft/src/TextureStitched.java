      ...
      if(this.field_94236_i != null) {
         ...
         if(this.field_94223_g >= ((Integer)var1.func_76340_b()).intValue()) {
            ...
            if(var2 != var3 && var3 >= 0 && var3 < this.field_94226_b.size()) {
               this.field_94228_a.func_104062_b(this.field_94224_d, this.field_94225_e, (Texture)this.field_94226_b.get(var3));
            }
         }
      } else {
         ...
         if(var4 != this.field_94222_f) {
            this.field_94228_a.func_104062_b(this.field_94224_d, this.field_94225_e, (Texture)this.field_94226_b.get(this.field_94222_f));
         }
      }
