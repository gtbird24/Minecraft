...
import net.minecraft.src.Variables;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public void runTick()
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            //Hack Key Binds
            while(this.gameSettings.keyBindHackJump.isPressed())
            {
            	Variables.hackJump = !Variables.hackJump;
            }
            
            while(this.gameSettings.keyBindJadeVision.isPressed())
            {
            	Variables.jadeVision = !Variables.jadeVision;
            }
